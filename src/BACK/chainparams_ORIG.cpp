...
public:
    CMainParams() {
        ...
        const char* pszTimestamp = "May, 2016 GoldBlocks Crypto and the Blockchain Technology Insdustry";
        CTransaction txNew;
        txNew.nTime = 1464385297;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        genesis.nVersion = 1;
        genesis.nTime    = 1464385297;
        genesis.nBits    = bnProofOfWorkLimit.GetCompact();
        genesis.nNonce   = 7596281;
		

        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000041d04ca2d3cd4e970b58c73c8c0a031376e27a64cf241af82060de9696"));
        assert(genesis.hashMerkleRoot == uint256("0xf257ccfe801784c849df571af68db48597404eb7121e43dabe559fb97757e11d"));
