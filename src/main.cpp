...
unsigned int nStakeMinAge = 24 * 60 * 60; // 5 hours
unsigned int nModifierInterval = 10 * 60; // time to elapse before new modifier is computed

int nCoinbaseMaturity = 90; //100: (90+10)
...
const string strMessageMagic = "GoldBlocks Signed Message:\n";
...
int64_t GetProofOfWorkReward(int nHeight, int64_t nFees)
{
    ...
    {
        nSubsidy = 2000 * COIN;   // For GenesysCoin CrowdFund
    }
...
{
    RenameThread("GoldBlocks-loadblk");
